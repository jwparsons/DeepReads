...
def main():
    ...
    # genre files
    fantasy_file = open('data/raw/fantasy_raw.txt', 'w')
    mystery_file = open('data/raw/mystery_raw.txt', 'w')
    philosophy_file = open('data/raw/philosophy_raw.txt', 'w')
    romance_file = open('data/raw/romance_raw.txt', 'w')
    science_fiction_file = open('data/raw/science_fiction_raw.txt', 'w')
